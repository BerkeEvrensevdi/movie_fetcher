...
from film.models import Movie as Mov,Person,Genre,Score,MovieHolder
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for user_id in recommend.keys():
            ...
            for film in films:  # film[0] = imdb_id  ve film[1] = user_score
                ...
                if control_exist:
                    ...
                    mov_holder = MovieHolder(movie=my_movie)
                    mov_holder.save()
                    user_profile.recommended_movies.add(mov_holder)
                    user_profile.save()
        ...
        res = "control count = %d" % control_count
